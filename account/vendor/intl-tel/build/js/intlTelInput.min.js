...
!function(a) {
    ...
    e.prototype = {
        ...
        _g: function(a, b) {
            for (var c = "", d = 0; d < a.length; d++) {
                var e = a[d];
                c += "<li class='country " + b + "' id='iti-item-" + e.iso2 + "' role='option' data-dial-code='" + e.dialCode + "' data-country-code='" + e.iso2 + "'>",
        ...
        _h: function() {
            ...
            b && !c ? this._v(a) : "auto" !== this.b.initialCountry && (this.b.initialCountry ? this._z(this.b.initialCountry.toLowerCase()) : b && c ? this._z("us") : (this.j = this.preferredCountries.length ? this.preferredCountries[0].iso2 : this.p[0].iso2,
            a || this._z(this.j)),
        ...
        _o: function() {
            ...
            this.n = this.m.removeClass("hide").attr("aria-expanded", "true").outerHeight(),
            !this.g) {
                var d = this.a.offset()
                  , e = d.top
                  , f = a(b).scrollTop()
        ...
        _z: function(a) {
            ...
            if (this._aa(),
            this.b.allowDropdown && (this.o.removeClass("active").attr("aria-selected", "false"),
            a)) {
                var f = this.o.find(".iti-flag." + a).first().closest(".country");
                f.addClass("active").attr("aria-selected", "true"),
                this.m.attr("aria-activedescendant", f.attr("id"))
            }
            return b.iso2 !== a
        },
        _aa: function() {
        ...
        _ac: function() {
            ...
            this.m.attr("aria-expanded", "false"),
    ...
    a.fn[f].loadUtils = function(b) {
        return a.fn[f].startedLoadingUtilsScript ? null : (a.fn[f].startedLoadingUtilsScript = !0,
        a.ajax({
            type: "GET",
            url: b,
            complete: function() {
